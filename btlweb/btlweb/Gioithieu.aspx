...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    <div class="khung">
        <div class="dongTren">
            ...
            <p style="font-size: 20px"><b>Giới thiệu về HouComputer </b></p>
        ...
        <div class="dongDuoi">
            ...
            <p>Tầm nhìn:</p>
            <p>HouComputer đặt mục tiêu đến năm 2030 trở thành một trong những thương hiệu hàng đầu trong lĩnh vực cung cấp laptop và phụ kiện công nghệ tại Việt Nam, mở rộng hệ thống cửa hàng phủ khắp cả nước và doanh thu tăng trưởng bền vững hàng năm.</p>

            <p>Sứ mệnh:</p>
            <p>HouComputer cam kết mang đến giá trị tối đa cho khách hàng bằng việc cung cấp sản phẩm chất lượng cao, dịch vụ chuyên nghiệp và tận tâm. Với tinh thần đổi mới không ngừng và sự hỗ trợ của công nghệ hiện đại, chúng tôi hướng đến việc tạo ra trải nghiệm mua sắm tối ưu, tiện lợi và đáng tin cậy cho mọi khách hàng.</p>
        </div>
    </div>
</asp:Content>
