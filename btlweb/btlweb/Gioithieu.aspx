...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    ...
    <div class="dongDuoi">
        <div class="cot">
            <p class="label" style="color:black">Tầm nhìn:</p>
            <p style="color:black">HouComputer đặt mục tiêu đến năm 2030 trở thành một trong những thương hiệu hàng đầu trong lĩnh vực cung cấp laptop và phụ kiện công nghệ tại Việt Nam, mở rộng hệ thống cửa hàng phủ khắp cả nước và doanh thu tăng trưởng bền vững hàng năm.</p>
        </div>
        <div class="cot">
            <p class="label" style="color:black">Sứ mệnh:</p>
